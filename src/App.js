  ...
  return (
    <div>
      ...
      <div className="mainarea">
        <div className="aboutus" id="aboutus">
          ...
          <article className="aboutusart">
            Rajkiya Engineering College Bijnor (Formerly Dr. Bhim Rao Ambedkar
            ...
            <button id="aboutusbutton">ReadMore</button>
          </article>
        </div>
        <div className="aside">
      ...
      <div className="aboutus" id="vision">
        <h1 className="aboutustext"></h1>
        <article className="aboutusart">
          The institute is recognised worldwide as a leader in the field of
